These are user contributed plugins for [shikigotchi](https://github.com/andatoshiki/shikigotchi), some of them have not been 
completely tested by the dev team, **use them at your own risk**.

In order to use these plugins, clone the repository anywhere on your unit and then add its path to `/etc/shikigotchi/config.yml` as:
